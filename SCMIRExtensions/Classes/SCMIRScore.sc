...
//
	...
	*recordNRTSCMIR { arg list, oscFilePath, outputFilePath, inputFilePath, sampleRate = 44100,
		...
		//now -V from -v for 3.7, thanks sc-users 14 Apr 2016, at 08:51, Nathan Ho
	recordNRTSCMIRParallel { arg oscFilePath, outputFilePath, inputFilePath, sampleRate = 44100, headerFormat =
		"AIFF", sampleFormat = "int16", options, completionString="", duration = nil, endfunc;
...
//
	...
	*recordNRTSCMIRParallel { arg list, oscFilePath, outputFilePath, inputFilePath, sampleRate = 44100,
		headerFormat = "AIFF", sampleFormat = "int16", options, completionString="", duration = nil, endFunc;
		this.new(list).recordNRTSCMIRParallel(oscFilePath, outputFilePath, inputFilePath, sampleRate,
		headerFormat, sampleFormat, options, completionString, duration,endFunc);
	}
